    ...
    public class SquaresModel
    {
       ...
       public int getSize() { return size; }
        ...
        public void StartNewGame(int size)
        {
            ...
            this.playerBluePoints = 0;
            this.playerRedPoints = 0;
            onPlayer = RandomGenerator();
        ...
        public void loadGame(string path)
        {
            ...
            this.board = tableWithFieldStates;
            this.size = gameStatus.Size;
            this.playerBluePoints = gameStatus.PlayerBlue;
            this.playerRedPoints = gameStatus.PlayerRed;
            this.onPlayer = gameStatus.playerToMove;
